...
export function Login() {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      // The browser will redirect if successful, so setLoading(false) only really matters on error
            ...
            <div className="mt-6">
              ...
              <div className="mt-6">
                <button
                  ...
                  className="w-full flex justify-center items-center gap-2 py-3 px-4 rounded-xl border border-white/10 bg-white/5 text-sm font-medium text-white hover:bg-white/10 transition-all disabled:opacity-50"
                >
                  {googleLoading ? (
